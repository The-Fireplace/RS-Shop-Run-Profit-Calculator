...
import dev.the_fireplace.shoprun.gui.GuiActionSelector;
import dev.the_fireplace.shoprun.gui.GuiAddData;
import dev.the_fireplace.shoprun.gui.GuiEditData;
...
public class ShopRunData extends JFrame
{
    ...
    private final JMenu fileM;
    private final JMenu editM;
    private final JMenu helpM;
